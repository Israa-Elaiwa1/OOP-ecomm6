<?php
  ...
  $query1   = "insert into orders(order_date, cust_ID	)
              values('$dates' ,'$customerId')";
  ...
  foreach ($_SESSION['cart'] as $k => $v) {
    ...
    $query2   = "insert into order_details(order_id, product_id)
                values('$lastID' ,'$k')";
...
$query 	= "select * from product where productId='$k'";
...
<img src ='../admin/images/{$row['productImage']}' width='100' hight='140'/>
</div>
</td>
<td class='column-2'> {$row['productName']}</td>
<td class='column-3'> {$row['productPrice']}</td>
<td class='column-4'>
<div class='wrap-num-product flex-w m-l-auto m-r-0'>
<div class='btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m'>
<i class='fs-16 zmdi zmdi-minus'></i>
</div>
<input class='mtext-104 cl3 txt-center num-product' type='number' name='num' value='$v'>
