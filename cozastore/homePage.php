...
<!-- Categories section -->
  ...
  echo'  <div class="sec-banner bg0 p-t-80 p-b-50 test">' ;
...
// echo' <img src="images/banner-01.jpg" alt="IMG-BANNER">';
echo " <img src=' ../admin/images/{$fetch['cat_img']}'  width='300' height='300' />";


echo" <a href ='products.php?id={$fetch['cat_id']}' class='block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3'> View Products  </a>";
...
echo'<div class="block1-link stext-101 cl0 trans-09">
Shop Now
</div>';
echo" </div>";
echo" </a>";
