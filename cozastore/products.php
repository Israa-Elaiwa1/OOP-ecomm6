...
{
 // echo  '<div class="row isotope-grid">' ;
echo '<div class="col-sm-6 col-md-4 col-lg-4 p-b-35 isotope-item women">' ;

echo ' <div class="block2">';
echo ' <div class="block2-pic hov-img0">';
echo " <img src=' ../admin/images/{$fetch['productImage']}' height='300' width='150' />";
...
echo ' <a href="product-detail.php?id='.$fetch['productId'].'" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">';
   echo $fetch['productName'];
echo ' </a>';
echo ' <span class="stext-105 cl3">';
   echo "$".$fetch['productPrice'];
